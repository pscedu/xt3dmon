...
void
gl_mouseh_null(__unusedx int button, __unusedx int state,
    __unusedx int u, __unusedx int v)
{
...
void
gl_mouseh_default(__unusedx int button, __unusedx int state, int u,
    int v)
{
	static int reset;
	struct glname *gn;
